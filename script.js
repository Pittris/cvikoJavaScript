"use strict";
document.addEventListener("DOMContentLoaded", function payment() {
  ...
  document
    ...
    .addEventListener("click", function (event) {
      ...
      document.querySelector("#vyCena").value = celkovaCena;
      ...
      // Proměnná pro zobrazení zprávy uživateli

      if (maxCena) {
        // Pokud je maximální cena vyplněna
        const message =
          celkovaCena > maxCena
            ? "Cena překračuje maximální cenu, kterou jste zadali."
            : "Cena je v pořádku, můžete nakoupit";
